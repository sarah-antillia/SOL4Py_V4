...
# If you would like to download the weight file "TOKYO2020_SPORT_PICTOGRAMS_Model_0.h5"
# from antillia.com
...
if main(__name__):
  try:
    weight_file = "TOKYO2020_SPORT_PICTOGRAMS_Model_0.h5"

    if os.path.exists(weight_file) != True:

      zip_file = "TOKYO2020_SPORT_PICTOGRAMS_Model_0.zip"
