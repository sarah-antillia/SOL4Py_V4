...
#  MaterializedTorusesRotationByKeyInput.py
...
from SOL4Py.opengl.ZOpenGLWireTorus import *
...
class MainView(ZOpenGLMainView):
  ...
  class OpenGLView(ZOpenGLView):
    ...
    def initializeGL(self):
      ...
      diffuse1      = [ 0.5, 0.0, 1.0, 1.0 ]
      diffuse2      = [ 0.0, 1.0, 0.4, 1.0 ]
      ...
      mat1 = ZOpenGLMateria(GL_FRONT, ambient, diffuse1, specular, emission, lowShining)
      mat2 = ZOpenGLMateria(GL_FRONT, black,   diffuse2, specular, black,    lowShining)
      mat3 = ZOpenGLMateria(GL_FRONT, black,   diffuse1, black,    emission, highShining)
      mat4 = ZOpenGLMateria(GL_FRONT, ambient, diffuse2, specular, black,    highShining)
      self.materias = [mat1, mat2, mat3, mat4]
      self.toruses = []
      for i in range(self.CUBES):
        if i%2 ==0:
          self.toruses.append(ZOpenGLWireTorus(self.materias[i], 0.2, 0.4, 40, 40))
        else:
          self.toruses.append(ZOpenGLSolidTorus(self.materias[i], 0.2, 0.4, 40, 400) )
