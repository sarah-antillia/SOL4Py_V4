...
#  BlackWhiteCheckImageTexturedCube.py
...
from SOL4Py.opengl.ZColoredCheckImage import *

class MainView(ZOpenGLMainView):
  ##--------------------------------------------
  class BlackWhiteCheckImageTexturedCube(ZOpenGLTexturedCube):

    def __init__(self):
      ZOpenGLTexturedCube.__init__(self)
      check_image = ZColoredCheckImage(r=False, g=True, b=False)
  ...
  class OpenGLView(ZOpenGLView):
    ...
    def initializeGL(self):
      ...
      self.texture = MainView.BlackWhiteCheckImageTexturedCube()
