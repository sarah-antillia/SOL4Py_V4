...
# If you would like to download the weight file "Torch_TOKYO2020_SPORT_PICTOGRAMS_Model_0.pt"
# from antillia.com
...
if main(__name__):
  try:
    weight_file = "Torch_TOKYO2020_SPORT_PICTOGRAMS_Model_0.pt"

    if os.path.exists(weight_file) != True:
      
      zip_file = "Torch_TOKYO2020_SPORT_PICTOGRAMS_Model_0.zip"
