...
from SOL4Py.network.ZThreadingMixInUDPServer  import *

###############################################
# Singleton pattern model
#
class CustomThreadingMixInUDPServer(ZThreadingMixInUDPServer):

  ##
  # Constructor
  def __init__(self, ipaddress, port):
    ZThreadingMixInUDPServer.__init__(self, ipaddress, port)
...
if __name__ == "__main__":
  ...
  server = CustomThreadingMixInUDPServer(ipaddress, port)
